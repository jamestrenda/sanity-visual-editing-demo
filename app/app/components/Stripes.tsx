const Stripes = () => {
  return (
    <div className="grid grid-cols-12 grid-rows-10 -skew-y-6 absolute bottom-0 origin-[0] w-full h-[40vw] ml-0 1mb-[25vw] md:-mb-[24vw] md:-skew-y-12 first:-mb-[24vw] first:md:-mb-[15.5vw] md:h-[31vw]">
