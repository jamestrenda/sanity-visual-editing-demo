...
import { REDIRECT_QUERY, REDIRECT_SETTINGS_ID_QUERY } from '~/lib/queries'
      ...
      onHandle: async () => {
        ...
        if (slug.current === publishedSlug?.current) {
          ...
          const existingRedirects: Redirect[] =
            await client.fetch(REDIRECT_QUERY)
          ...
          if (existingRedirect) {
            ...
            const id = await client.fetch(REDIRECT_SETTINGS_ID_QUERY)
